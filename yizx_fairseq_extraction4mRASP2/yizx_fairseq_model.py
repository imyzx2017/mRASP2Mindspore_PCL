...
from fairseq.models import register_model_architecture, FairseqIncrementalDecoder
from fairseq.modules import FairseqDropout, PositionalEmbedding, LayerNorm, \
    LayerDropModuleList, TransformerEncoderLayer, SinusoidalPositionalEmbedding, \
    AdaptiveSoftmax, TransformerDecoderLayer
...
if __name__ == '__main__':
    ...
    # myDict = Dictionary()
    # encoder = FairseqEncoder(myDict)
    # decoder = FairseqDecoder(myDict)
    # myen2deModel = FairseqEncoderDecoderModel(encoder, decoder)
    # print(myen2deModel)
    #
    # args = None
    #
    # myTransModel = TransformerModel(args, encoder, decoder)
    # print(myTransModel)
    # myBaseModel = BaseFairseqModel()